...
class HumeSentimentAnalyzer:
    ...
    def analyze_audio(self, file_path):
        ...
        try:
            ...
            job.await_complete()   # 等待 Hume.ai 处理你的音频文件
            print("Job completed")
            predictions = job.get_predictions()  # 得到hume.ai的情感分析结果
            return self._process_predictions(predictions)   # 提取出你关心的情绪（emotions）、情感（sentiments）、毒性（toxicity）得分
